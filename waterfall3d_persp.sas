...
%macro project(ds=, x=x, y=y, z=z, rotx=105, roty=200, rotz=0);
data &ds._p;
  ...
  m[1,1]=n/r;   m[1,2]=0.0;  m[1,3]=0.0;      m[1,4]=0.0;
  m[2,1]=0.0;   m[2,2]=n/t;  m[2,3]=0.0;      m[2,4]=0.0;
  m[3,1]=0.0;   m[3,2]=0.0;  m[3,3]=(n+f)/(n-f); m[3,4]=2*n*f/(n-f);
  m[4,1]=0.0;   m[4,2]=0.0;  m[4,3]=-1;      m[4,4]=0.0; 

  /*--Set up translation matrix--*/
  tr[1,1]=1.0;   tr[1,2]=0.0;  tr[1,3]=0.0;      tr[1,4]=0.0;
  tr[2,1]=0.0;   tr[2,2]=1.0;  tr[2,3]=0.0;      tr[2,4]=0.0;
  tr[3,1]=0.0;   tr[3,2]=0.0;  tr[3,3]=1.0;		 tr[3,4]=-5.0;
